...
To store a Postback: You must configure the proper parameters and pass it to the storePostback function. [See Examples Below].  The method will return true if it was completed 
